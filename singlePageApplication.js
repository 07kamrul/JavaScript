	...
	function display(){
		...
		n.innerHTML = idTextField;
		e.innerHTML = emailTextField;
		id.innerHTML = phoneTextField;
	}
	var x = {
		"name" : "Hasan",
		"Age" : "90",
	...
	function validate(){
		...
		}else if(!idTextField.startsWith("Md") && !idTextField.startsWith("Mr") && !idTextField.startsWith("Mrs")){
			err.style.color="red";
		...
		if(emailTextField==""){
			...
			alert("Successfully added "+idTextField);
		}
	}
	function hide(){
